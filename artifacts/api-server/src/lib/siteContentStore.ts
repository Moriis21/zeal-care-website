...
export const DEFAULT_CONTENT: SiteContent = {
  ...
  whoWeAre: {
    ...
    team: [
      { name: "Titus S. Foko", role: "Founder & Executive Director", bio: "Titus S. Foko is the visionary Founder and Executive Director of Zeal Care. With a background in Development Work and Community Development, he holds a BSc in Development Work from Stella Maris Polytechnic and a Certificate in Aspire Institute Leaders' Program from Boston University. Born and raised in Liberia, Titus experienced firsthand the devastating impact of educational inequality.", img: "/attached_assets/pdf_images/img-001.jpg" },
