    ...
    <section id="home" className="relative min-h-screen flex items-center pt-24 pb-16 overflow-hidden bg-primary text-primary-foreground">
      ...
      <div className="container relative z-10 mx-auto px-4 grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold leading-tight mb-6" data-testid="heading-hero">
            {titleMain}
            {titleAccent && (
              <>
                <br />
          ...
          <p className="text-base sm:text-lg md:text-xl text-primary-foreground/90 mb-8 leading-relaxed max-w-lg" data-testid="text-hero-desc">
            {heroSubtitle}
          </p>
          ...
          <div className="flex flex-wrap gap-3">
            <Button
              ...
              className="bg-secondary text-primary hover:bg-secondary/90 rounded-full px-5 py-2.5 sm:px-7 sm:py-3 text-sm sm:text-base font-bold h-auto"
            ...
            <Button
              ...
              className="bg-transparent border-primary-foreground text-primary-foreground hover:bg-primary-foreground hover:text-primary rounded-full px-5 py-2.5 sm:px-7 sm:py-3 text-sm sm:text-base font-bold h-auto"
