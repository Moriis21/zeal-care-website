  ...
  return (
    <section className="py-20 md:py-24 bg-[#061A32] overflow-hidden">
      <div className="container mx-auto px-5 sm:px-6">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-[#FBD308]/10 border border-[#FBD308]/30 rounded-full px-5 py-2 mb-6">
            <div className="w-2 h-2 rounded-full bg-[#FBD308] animate-pulse" />
            <span className="text-[#FBD308] text-sm font-bold uppercase tracking-widest">{t("partners.badge")}</span>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-5 mb-12">
          {STRATEGIC_PARTNERS.map((partner, index) => (
            ...
            >
              <div className="relative overflow-hidden rounded-2xl border border-white/10 hover:border-[#FBD308]/40 transition-all duration-300 hover:shadow-lg hover:shadow-[#FBD308]/10 hover:-translate-y-1">
                <div
                ...
                <div className="absolute inset-0 bg-[#061A32]/95 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center rounded-2xl p-4">
                  <div className="text-center">
                    <p className="text-[#FBD308] font-black text-base mb-1">{partner.name}</p>
                    <p className="text-white/70 text-xs leading-snug mb-3">{partner.description}</p>
                    <div className="px-3 py-1 bg-[#FBD308]/20 rounded-full inline-block">
                      <p className="text-[#FBD308] text-xs font-semibold">{partner.type}</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <motion.div
          ...
          className="bg-gradient-to-r from-[#09609A]/30 to-transparent border border-white/10 rounded-2xl px-8 py-6 flex flex-col sm:flex-row items-center justify-between gap-4"
        >
          <div>
          ...
          <a
            ...
            className="whitespace-nowrap bg-[#FBD308] text-[#061A32] px-7 py-3 rounded-full font-black text-sm hover:bg-[#FBD308]/90 transition-all hover:scale-105"
          >
            {t("partners.ctaBtn")}
          </a>
        </motion.div>
