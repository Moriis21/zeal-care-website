...
export function DonationTicker({ stats }: { stats: DonationStats | null }) {
  ...
  return (
    <div ref={ref} className="bg-primary py-12 md:py-16 border-y border-white/10">
      <div className="container mx-auto px-5 sm:px-6">
        ...
        {stats?.lastUpdated && stats.totalCount > 0 && (
          <p className="text-center text-white/30 text-xs mt-5 flex items-center justify-center gap-1.5">
