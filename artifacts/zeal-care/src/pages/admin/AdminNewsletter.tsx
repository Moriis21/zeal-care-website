      ...
      <div className="space-y-5">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="border border-slate-200 rounded-xl pl-9 pr-4 py-2.5 text-sm focus:outline-none focus:border-[#09609A] w-56"
            />
          </div>
          <button
            onClick={exportCsv}
            disabled={filtered.length === 0}
            className="flex items-center gap-2 bg-[#061A32] text-white px-4 py-2.5 rounded-xl text-sm font-bold hover:bg-[#09609A] transition-colors disabled:opacity-40"
          >
        ...
        <div className="grid grid-cols-3 gap-3">
          <div className="bg-white rounded-2xl border border-slate-200 p-5 flex items-center gap-4">
            <div className="w-10 h-10 bg-[#09609A]/10 rounded-xl flex items-center justify-center">
              <Users className="w-5 h-5 text-[#09609A]" />
            </div>
            <div>
...
function stringToColor(str: string): string {
  const colors = ["#09609A", "#7C3AED", "#059669", "#DC2626", "#D97706", "#DB2777", "#0891B2", "#EA580C"];
  let hash = 0;
