      ...
      <div className="space-y-5">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <input
            ...
            className="border border-slate-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-[#09609A] w-64"
          />
          <button
            onClick={exportCsv}
            className="flex items-center gap-2 bg-[#061A32] text-white px-4 py-2.5 rounded-xl text-sm font-bold hover:bg-[#09609A] transition-colors"
          >
        ...
        {filtered.length > 0 && (
          <div className="grid grid-cols-3 gap-3">
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-4 text-center">
              <p className="text-2xl font-black text-[#09609A]">${total.toLocaleString()}</p>
              <p className="text-xs text-slate-400 font-semibold">
                  ...
                  {r.donorEmail && (
                    <div className="flex items-center gap-2">
                      ...
                      <a
                        ...
                        className="text-xs text-slate-500 hover:text-[#09609A] transition-colors truncate"
                      >
                        {r.donorEmail}
                      </a>
                    </div>
                ...
                <tbody className="divide-y divide-slate-50">
                  {filtered.map((r) => (
                    <tr key={r.id} className="hover:bg-slate-50 transition-colors">
                      ...
                      <td className="px-5 py-3.5 font-black text-[#09609A]">${r.amount.toLocaleString()}</td>
                      <td className="px-5 py-3.5">
